...
class OfflineEvaluatorAgent:
    ...
    async def astep(
        ...
        *,
        ...
        if not api_key:
            raise RuntimeError(
                "OPENAI_API_KEY is not set. Export OPENAI_API_KEY and "
                "OPENAI_BASE_URL (see .env.example) before running."
            )
...
class CandidateCorrectnessEvaluator:
    ...
    def __init__(
        ...
        *,
        ...
        allow_uncached_evaluator_calls: bool = True,
    ):
        ...
        self.allow_uncached_evaluator_calls = bool(allow_uncached_evaluator_calls)
    ...
    def label_candidate(
        ...
        *,
        ...
        if not self.allow_uncached_evaluator_calls:
            return CandidateLabel(
                None,
                f"{self.evaluator_type}-uncached",
                "No runtime or persistent-cache label was available; uncached evaluator calls are disabled.",
            )
